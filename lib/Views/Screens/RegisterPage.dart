        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              MyTextFiled(textController: widget.email,hint: "email",myIcon: Icons.mail_outline,focus: false,),
              SizedBox(height: 10.h,),
              MyTextFiled(textController: widget.password,hint: "password",myIcon: Icons.lock_outline,focus: false,),
              SizedBox(height: 10.h,),
              MyTextFiled(textController: widget.phone,hint: "phone",myIcon: Icons.phone ,focus: false,),
              SizedBox(height: 10.h,),
              Row(
